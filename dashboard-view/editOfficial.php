              ...
              <!-- FORM STARTS -->
                <form action="crud.php" method="POST">
                      <div class="form-group">
                        <label for="official-id" class="col-form-label">Official ID</label>
                        <input type="number" class="form-control" id="official_id" name="official_id" required>
                      </div>
                      <div class="form-group">
                      ...
                      <button type="submit" name="submit-athlete" class="btn btn-theme"><i class="fa fa-location-arrow"></i>Add Official</button>
                </form>
                <!--// FORM ENDS -->
